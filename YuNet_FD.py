...
# download model from "https://github.com/opencv/opencv_zoo/blob/main/models/face_detection_yunet/face_detection_yunet_2023mar.onnx"
...
parser.add_argument('--model', '-m', type=str, default='',
                    help="Usage: Set model type, defaults to 'face_detection_yunet_2023mar.onnx'.") # download model from "https://github.com/opencv/opencv_zoo/blob/main/models/face_detection_yunet/face_detection_yunet_2023mar.onnx"
