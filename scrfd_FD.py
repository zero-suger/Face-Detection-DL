# This is official 'scrfd' code from insightface "THANK YOU"
...
import argparse
def parse_arguments():
    parser = argparse.ArgumentParser(description='Script for detecting objects in images using SCRFD model.')

    parser.add_argument('--image_path', type=str, help='Path to the input image file.')
    parser.add_argument('--model_path', type=str, help='Path to the SCRFD model file.')
    parser.add_argument('--use_webcam', action='store_true', help='Use webcam for real-time detection.')
...
def main():
    ...
    detector = SCRFD(model_file=args.model_path)
    detector.prepare(-1)
    ...
    if args.use_webcam:
        ...
        while True:
            ...
            frame = detect_objects(frame, detector)
        ...
        for _ in range(1):
            ...
            img = detect_objects(img, detector)
